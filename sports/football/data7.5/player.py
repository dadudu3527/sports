...
class Player:
    ...
    def re_parse_data(self,data,player_id):  
            ...
            for i in range(1,len(tr)+1):
                ...
                if td:
                    for r in range(1,len(td)+1):
                        ...
                        player_honor_item['detail'] ='\n'.join(player_honor_content)
    ...
    def run_player(self,url,teamid):
