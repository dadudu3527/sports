...
class Match:
    def __init__(self):
        ...
        dbnameFootball = client['foot']
        self.errorCol = dbnameFootball['errorCol']
        self.collection = dbnameFootball['matchCollection']
        self.col_read = dbnameFootball['getLeagueId']
        self.collection_league = dbnameFootball['match']
        self.collection_1 = dbnameFootball['all_match']
        self.collection_2 = dbnameFootball['senior_schedule'] #高级赛程集合
        self.collection_3 = dbnameFootball['general_schedule'] #普通赛程集合
        self.collection_4 = dbnameFootball['senior_match_result'] #高级赛果集合
        self.collection_5 = dbnameFootball['general_match_result'] #普通赛果集合
            ...
            if tr_length:
                for i in range(1,len(tr_length)):
                    ...
                    if matchId:
                        ...
                        # level = self.collection_league.find_one({'leagueId':leagueId}).get('level')
