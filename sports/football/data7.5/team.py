...
class Team:
            ...
            for i in range(1, len(tr) + 1):
                ...
                if td:
                    for r in range(1, len(td) + 1):
                        ...
                        player_honor_item['detail'] ='\n'.join(player_honor_content_time)
    ...
    def save_database(self,team_id,data):
        ...
        if not team:
            ...
            if team != data :
                ...
                logger.info('数据重复{}'.format(team_id))
    ...
    def thread_pool(self):
        for i in range(10000,52054):
            ...
            #self.run_team2(url)
            try:
                self.pool.apply_async(self.run_team2,args=(url,))
