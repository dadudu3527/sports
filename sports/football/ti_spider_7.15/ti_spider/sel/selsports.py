        ...
        if tr_length:
            for i in range(len(tr_length)):
                ...
                if shijian:
                    ...
                    continue
        # fenzusai_a = self.my_xpath(page,'//*[@id="scoreboard"]/div[@class="data-type-check m-b-15"]/a') #获取分组赛标签
        # if fenzusai_a:
        #     self.parse_data_fenzusai(page)
...
if __name__ == "__main__":
    a = TiyuData('https://data.leisu.com/zuqiu-8872')
    a.run()
