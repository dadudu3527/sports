...
fh = logging.FileHandler('C:\\sports\\football\\data\\match.log')
...
class Match:
                ...
                for i in range(1, len(tr_length)):
                    ...
                    if matchId:
                        ...
                        try:
                            ...
                            logger.info('matchId:{}保存失败！because:{}'.format(matchId,e))
                            print('matchId:{}保存失败！because:{}'.format(matchId,e))
                            continue
    ...
    def thread_pool2(self):   
        ...
        # liu = ['9194','9157','9189','9187','9168','9170','9178','9174', '9162', '9183', '9135', '9148', '9185', '9151', '9191', '9196', '9180', '9192', '9181', '9193', '9173', '9190', '9176', '9136', '9179', '9197', '9184', '9177', '9171', '9143', '9142', '9122', '9169', '9172', '9186', '9129', '9182', '9195', '9198', '9199', '9188', '9175']
        # for i in li1:
            # note = self.col_read.find({'leagueName':i})
            # for r in note:
                # m = r.get('seasonId')
                # li.append(m)
        # note = self.col_read.find()
        # for r in note:
            # id = r.get('seasonId')
            # li.append(id)
        # li.reverse()
        # liu.reverse()
        # for r in liu:
            # # self.pool.apply_async(self.parse_data_saiguo, args=(r,))
            # self.parse_data_saiguo(int(r))
        # # self.pool.close()
        # # self.pool.join()
        # li.reverse()
        for i in li:
            # self.pool.apply_async(self.parse_data_saiguo, args=(i,))
            self.parse_data_saiguo(int(i))
        # self.pool.close()
        # self.pool.join()
